<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white">Manajemen Produk</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Kelola inventaris produk Anda</p>
            </div>
                        ...
                        @forelse($products as $product)
                            <tr class="transition-colors bg-[#fef3c7] dark:bg-gray-800 hover:bg-[#fde89a] dark:hover:bg-gray-700/50">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @else
                                        <x-badge type="warning">Tidak Aktif</x-badge>
                                    @endif
                                </td>
                                <td class="px-6 py-4">
                        ...
                        @empty
                            <tr class="bg-[#fef3c7] dark:bg-gray-800">
                                <td colspan="7" class="px-6 py-12 text-center">
                                    ...
                                    <p class="text-lg text-gray-600 dark:text-gray-400">Tidak ada produk ditemukan</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <x-modal name="product-modal" :show="false">
        <div class="p-6">
            <h3 class="mb-4 text-lg font-bold text-gray-900 dark:text-white" id="product-modal-title">Tambah Produk</h3>
            ...
            <form id="product-form" method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Nama Produk</label>
                    ...
                    <div>
                        <label class="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Kategori</label>
                    ...
                    <div>
                        <label class="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Harga</label>
                    ...
                    <div>
                        <label class="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Stok</label>
