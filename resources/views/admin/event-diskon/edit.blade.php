...
<div class="px-4 py-8 mx-auto max-w-4xl sm:px-6 lg:px-8">
    <div class="mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Edit Discount Event</h1>
                <p class="mt-1 text-sm text-gray-500">Modify the details of this promotional event.</p>
            </div>
        </div>
    </div>
    ...
    <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 rounded-2xl ring-1 ring-gray-200 dark:ring-gray-700">
        <form action="{{ route('admin.event-diskon.update', $event->id) }}" method="POST" class="p-6 sm:p-8">
            @csrf
            @method('PUT')
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <textarea id="description" name="description" rows="3" 
                                          class="block w-full rounded-md border-0 py-2 text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 dark:bg-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-yellow-500 sm:text-sm sm:leading-6">{{ old('description', $event->description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <div class="mt-2 relative rounded-md shadow-sm">
                                <input type="number" step="0.01" min="0" max="100" name="discount_percentage" id="discount_percentage" required value="{{ old('discount_percentage', floatval($event->discount_percentage)) }}"
                                       class="block w-full rounded-md border-0 py-2 pr-10 text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 dark:ring-gray-600 dark:bg-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-yellow-500 sm:text-sm sm:leading-6">
                ...
                <div class="pt-6 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="datetime-local" name="start_date" id="start_date" required value="{{ old('start_date', $event->start_date->format('Y-m-d\TH:i')) }}"
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="datetime-local" name="end_date" id="end_date" required value="{{ old('end_date', $event->end_date->format('Y-m-d\TH:i')) }}"
                                       class="block w-full rounded-md border-0 py-2 text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 dark:bg-gray-700 focus:ring-2 focus:ring-inset focus:ring-yellow-500 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    </div>
                ...
                <div class="pt-6 border-t border-gray-100 dark:border-gray-700">
                    <div class="relative flex items-start">
                        <div class="flex h-6 items-center">
                            <input id="is_active" name="is_active" value="1" type="checkbox" {{ old('is_active', $event->is_active) ? 'checked' : '' }}
