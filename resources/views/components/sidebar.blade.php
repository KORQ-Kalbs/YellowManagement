<aside 
    ...
    <div class="flex items-center justify-between p-4">
        <div class="flex items-center min-w-0 space-x-3 overflow-hidden">
            ...
            <div x-show="sidebarOpen" x-transition class="overflow-hidden whitespace-nowrap">
                <h1 class="text-base font-bold text-white truncate">Yellow Drink</h1>
    ...
    <!-- Navigation Menu -->
    <nav class="flex-1 px-1 py-2 space-y-1 overflow-y-auto h-[calc(100vh-200px)]">
        <!-- Dashboard -->
        <a href="{{ route('dashboard') }}" 
           @class([
               'flex items-center px-3 py-2.5 rounded-lg font-medium transition-all duration-200 space-x-3 text-white group',
    ...
    <div x-data="{ profileModalOpen: false }">
        ...
        <div class="px-3 py-2">
            <button @click="theme = theme === 'dark' ? 'light' : 'dark'" 
                    class="flex items-center w-full px-3 py-2 space-x-3 text-white transition-all duration-200 rounded-lg hover:bg-white hover:bg-opacity-10"
                    :title="!sidebarOpen ? 'Toggle Theme' : ''">
                <svg class="flex-shrink-0 w-5 h-5" x-show="theme === 'light'" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
                </svg>
                <svg class="flex-shrink-0 w-5 h-5" x-show="theme === 'dark'" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="p-3">
            <button @click="profileModalOpen = true" 
                ...
                <div class="flex items-center justify-center flex-shrink-0 w-9 h-9 text-sm font-bold text-yellow-500 bg-white rounded-full">
